...
#Preview {
    TourCell(tour:  ToursModel(imageName: "Coit-Tower", likes: 100, dislikes: 5, tourPlaceName: "Coit Tower", cityName: "San Francisco", touredPeople: 1330, rank: 5, price: 200, duration: 3, description: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.", driverCharges: 100, taxAmount: 25))
}
